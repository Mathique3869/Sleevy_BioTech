# config.txt sous /boot/
# dtparam=i2c_arm=on, i2c_arm_baudrate=400000
# dtoverlay=i2c-gpio,bus=5,i2c_gpio_delay_us=1,i2c_gpio_sda=5,i2c_gpio_scl=6
# permet de mettre un sda sur GPIO5 et un scl sur GPIO6

# pour brancher le MAX30102
# jaune = 3.3 volts
# vert = sda
# bleu = scl
# blanc = gpio4 = int
# violet = ground (donne violet et noir à l'autre extremité)
